...
// Firebase imports 
import {
    DocumentData, collection, deleteDoc,
    doc, getDoc, getDocs,
...
class PremixApi extends FirebaseApi {
    ...
    public async updatePrdocurCard(card: productType) {
        try {
            // Get document ref
            const ref = doc(this.firestore, "Premixes/", card.id as string);
    ...
    public async deleteProduct(productID: string) {
        try {
            ...
            await deleteDoc(doc(this.firestore, "Premixes/", productID));
    ...
    public async addProduct(card: productType) {
        try {
            ...
            const docRef = await collection(this.firestore, "Premixes");
    ...
    public async getProductByID(id: string): Promise<DocumentData | undefined> {
        try {
            let docRef = doc(this.firestore, "Premixes/", id);
    ...
    /**
     * Get all premixes of all teams marked as visibleForAll users
     * 
